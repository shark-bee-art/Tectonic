...
public enum L10n {
    ...
    public static let dict: [String: [String: String]] = [
        ...
        "option.callPut": ["zh": "看涨/看跌", "en": "Call / Put", "ja": "コール/プット"],
        ...
        // 账户
        "account.manage": ["zh": "账户管理", "en": "Accounts", "ja": "口座管理"],
        "account.add": ["zh": "添加账户", "en": "Add Account", "ja": "口座を追加"],
        "account.edit": ["zh": "编辑账户", "en": "Edit Account", "ja": "口座を編集"],
        "account.name": ["zh": "账户名称", "en": "Account Name", "ja": "口座名"],
        "account.type": ["zh": "账户类型", "en": "Account Type", "ja": "口座タイプ"],
        "account.currency": ["zh": "币种", "en": "Currency", "ja": "通貨"],
        "account.platform": ["zh": "券商", "en": "Broker", "ja": "証券会社"],
        "account.default": ["zh": "默认账户", "en": "Default", "ja": "デフォルト"],
        "account.all": ["zh": "全部账户", "en": "All Accounts", "ja": "すべての口座"],
        "account.empty": ["zh": "暂无账户", "en": "No accounts", "ja": "口座なし"],
        "account.emptyHint": ["zh": "添加账户后可记录多券商持仓\n每笔交易需归属一个账户", "en": "Add accounts to track multiple brokers\nEach transaction belongs to an account", "ja": "複数の証券会社を追跡するには口座を追加\n各取引は口座に属します"],
        "account.type.securities": ["zh": "证券", "en": "Securities", "ja": "証券"],
        "account.type.cash": ["zh": "现金", "en": "Cash", "ja": "現金"],
        "account.type.crypto": ["zh": "加密", "en": "Crypto", "ja": "暗号資産"],
        "account.type.creditCard": ["zh": "信用卡", "en": "Credit Card", "ja": "クレジットカード"],
        // 活动类型
        "activity.buy": ["zh": "买入", "en": "Buy", "ja": "買い"],
        "activity.sell": ["zh": "卖出", "en": "Sell", "ja": "売り"],
        "activity.split": ["zh": "拆股", "en": "Split", "ja": "株式分割"],
        "activity.dividend": ["zh": "分红", "en": "Dividend", "ja": "配当"],
        "activity.interest": ["zh": "利息", "en": "Interest", "ja": "利息"],
        "activity.deposit": ["zh": "存款", "en": "Deposit", "ja": "入金"],
        "activity.withdrawal": ["zh": "取款", "en": "Withdrawal", "ja": "出金"],
        "activity.transferIn": ["zh": "转入", "en": "Transfer In", "ja": "振替入金"],
        "activity.transferOut": ["zh": "转出", "en": "Transfer Out", "ja": "振替出金"],
        "activity.fee": ["zh": "费用", "en": "Fee", "ja": "手数料"],
        "activity.tax": ["zh": "税", "en": "Tax", "ja": "税金"],
        "activity.credit": ["zh": "贷记", "en": "Credit", "ja": "入金処理"],
        "activity.adjustment": ["zh": "调整", "en": "Adjustment", "ja": "調整"],
        "activity.unknown": ["zh": "未知", "en": "Unknown", "ja": "不明"],
        "activity.amount": ["zh": "金额", "en": "Amount", "ja": "金額"],
        "activity.account": ["zh": "账户", "en": "Account", "ja": "口座"],
        // 持仓页（自动推导）
        "holdings.derived": ["zh": "持仓由交易记录自动推导", "en": "Holdings are derived from transactions", "ja": "保有銘柄は取引から自動計算されます"],
        "holdings.emptyDerived": ["zh": "暂无持仓\n添加交易记录后自动推导持仓与成本", "en": "No holdings\nHoldings and cost are derived from transactions", "ja": "保有銘柄なし\n取引を追加すると自動計算されます"],
        "holdings.cash": ["zh": "现金", "en": "Cash", "ja": "現金"],
        "holdings.realized": ["zh": "已实现盈亏", "en": "Realized P/L", "ja": "実現損益"],
        "holdings.unrealized": ["zh": "浮动盈亏", "en": "Unrealized P/L", "ja": "評価損益"],
        "holdings.netContribution": ["zh": "净投入", "en": "Net Contribution", "ja": "純入金"],
        "holdings.history": ["zh": "组合历史", "en": "Portfolio History", "ja": "ポートフォリオ履歴"],
        "holdings.positionCount": ["zh": "持仓数", "en": "Positions", "ja": "ポジション数"],
        "holdings.avgCost": ["zh": "均价", "en": "Avg Cost", "ja": "平均単価"],
        "holdings.quantity": ["zh": "数量", "en": "Qty", "ja": "数量"],
        "holdings.emptyTxHint": ["zh": "请先添加一笔交易记录", "en": "Add a transaction first", "ja": "先に取引を追加してください"],
